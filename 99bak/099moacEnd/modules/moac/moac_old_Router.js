...
module.exports = function (app) {
    ...
    app.post(CURRENT_API_VERSION + '/new', urlencodedParser, function (req, res) {
        ...
        try {
            ...
            res.end(JSON.stringify(buildResponse(null, account)));
        }
        catch (error) {
    ...
    // balance
    app.post(CURRENT_API_VERSION + '/balance', urlencodedParser, function (req, res) {
        ...
        try{
            ...
            res.end(JSON.stringify(buildResponse(null, balance)));
        }
        catch(error){
            res.end(JSON.stringify(buildResponse(error, null)));
        }
    ...
    //  moac transfer
    app.post(CURRENT_API_VERSION + '/transfer', urlencodedParser, function (req, res) {
    ...
    // transfer with nonce
    app.post(CURRENT_API_VERSION + '/transferWithNonce', urlencodedParser, function (req, res) {
        var fromAddress = req.body.fromAddress;
        var fromSecret = req.body.fromSecret;
        var toAddress = req.body.toAddress;
        var amount = req.body.amount;
    ...
    // get transation info
    app.post(CURRENT_API_VERSION + '/getCount', urlencodedParser, function (req, res) {
        var address = req.body.address;
        try {
            var count = moacOperation.getCount(address);
            res.end(JSON.stringify(buildResponse(null, count)));
        }
        catch (error) {
            res.end(JSON.stringify(buildResponse(error, null)));
        }
    ...
    // get transation info
    app.post(CURRENT_API_VERSION + '/getTransaction', urlencodedParser, function (req, res) {
        var hash = req.body.hash;
        try {
            var tx = moacOperation.getTransaction(hash);
            res.end(JSON.stringify(buildResponse(null, tx)));
        }
        catch (error) {
            res.end(JSON.stringify(buildResponse(error, null)));
        }
    ...
    // get local key
    app.post(CURRENT_API_VERSION + '/getKey', urlencodedParser, function (req, res) {
        ...
        try {
            var key = moacOperation.getKey(datadir, address, passphrase);
            res.end(JSON.stringify(buildResponse(null, key)));
        }
        catch (error) {
            res.end(JSON.stringify(buildResponse(error, null)));
        }
    ...
    //  erc20 create
    app.post(CURRENT_API_VERSION + TOKEN_TYPE_ERC20 + '/deployContractByCoinbase', urlencodedParser, function (req, res) {
    ...
    app.post(CURRENT_API_VERSION + TOKEN_TYPE_ERC20 + '/deployContract', urlencodedParser, function (req, res) {
        var address = req.body.address;
    ...
    //  erc20 balance
    app.post(CURRENT_API_VERSION + TOKEN_TYPE_ERC20 + '/balance', urlencodedParser, function (req, res) {
        var address = req.body.address;
        ...
        try {
            res.end(JSON.stringify(buildResponse(null, moacOperation.getBalance_Erc20ByAbi(address, contractAddress, tokenName, abi))));
        }
        catch (error) {
            res.end(JSON.stringify(buildResponse(error, null)));
        }
    ...
    app.post(CURRENT_API_VERSION + TOKEN_TYPE_ERC20 + '/balance2', urlencodedParser, function (req, res) {
        var address = req.body.address;
        var contractAddress = req.body.contractAddress;
        var tokenName = req.body.tokenName;
        var contractContent = req.body.contractContent;
        ...
        try {
            res.end(JSON.stringify(buildResponse(null, moacOperation.getBalance_Erc20ByContract(address, contractAddress, tokenName, contractContent))));
        }
        catch (error) {
            res.end(JSON.stringify(buildResponse(error, null)));
        }
    ...
    //  erc20 transfer
    app.post(CURRENT_API_VERSION + TOKEN_TYPE_ERC20 + '/transfer', urlencodedParser, function (req, res) {
    ...
    app.post(CURRENT_API_VERSION + TOKEN_TYPE_ERC20 + '/transferFrom', urlencodedParser, function (req, res) {
        //from, secret, to, contractAddress, tokenName, abi, value
        var from = req.body.from;
        var secret = req.body.secret;
        var to = req.body.to;
    ...
    app.post(CURRENT_API_VERSION + TOKEN_TYPE_ERC20 + '/abi', urlencodedParser, function (req, res) {
        var tokenName = req.body.tokenName;
        var contractContent = req.body.contractContent;

        try {
            res.end(JSON.stringify(buildResponse(null, utility.getAbi(tokenName, contractContent))));
        }
        catch (error) {
            res.end(JSON.stringify(buildResponse(error, null)));
        }
    ...
    //  yikong balance
    app.post(CURRENT_API_VERSION + TOKEN_TYPE_YIKONG + '/balance', urlencodedParser, function (req, res) {
        var address = req.body.address;
        try {
            res.end(JSON.stringify(buildResponse(null, moacOperation.getBalance_Yikong(address))));
        }
        catch (error) {
            res.end(JSON.stringify(buildResponse(error, null)));
        }
    ...
    //  yikong transfer
    app.post(CURRENT_API_VERSION + TOKEN_TYPE_YIKONG + '/transfer', urlencodedParser, function (req, res) {
        //from, secret, to, contractAddress, tokenName, abi, value
        var from = req.body.from;
        var secret = req.body.secret;
        var to = req.body.to;
    ...
    app.post(CURRENT_API_VERSION + '/collect', urlencodedParser, function (req, res) {
    ...
    app.post(CURRENT_API_VERSION + '/one2many', urlencodedParser, function (req, res) {
        var fromAddress = req.body.fromAddress;
        var fromSecret = req.body.fromSecret;
